...
3. Download the [docker-openvpn@.service](https://raw.githubusercontent.com/truffelnl/docker-openvpn-ng/latest/init/docker-openvpn%40.service)
   file to `/etc/systemd/system`:

        curl -L https://raw.githubusercontent.com/truffelnl/docker-openvpn-ng/latest/init/docker-openvpn%40.service | sudo tee /etc/systemd/system/docker-openvpn@.service
